...
Physalia course `Practical GWAS Using Linx and R` are greatly appreciated. In particular, the Stata program p0.do was adapted from code originally by Dr Jian'an Luan.
